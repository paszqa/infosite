<canvas id="chart_uptime" width="600" height="500"></canvas>
<script>
//d3.csv('https://s3-us-west-2.amazonaws.com/s.cdpn.io/2814973/atp_wta.csv')
	d3.dsv(';', 'logs/uptime.csv').then(makeChart);
...
function makeChart(profit) {
	...
	var chart = new Chart('chart_uptime', {
		type: 'line',
		data: {
			labels: dateLabels,
			datasets: [{
